...
class AttendanceClass9 extends Page
{
    protected static ?string $navigationIcon = 'heroicon-o-clipboard-document-check';
    protected static ?string $title = 'Absensi Kelas 9';
    protected static string $view = 'filament.pages.attendance-class9';
    ...
    {
        return 'attendance-class9'; // ini slug & route path
    }
    public function mount(): void
    {
        ...
        if ($this->subject_id && $this->date) {
            ...
            // default tampilkan semua siswa kelas 9
            $this->attendances = Student::where('class', '9')
                ->orderBy('name')
                ->get()
                ->map(fn ($s) => [
                    'id' => $s->id,
    ...
    private function loadAttendance(): void
    {
        ...
        $existing = Attendance::where('class', '9')
    ...
    public function save(): void
    {
        ...
        Notification::make()
            ->title('Absensi Kelas 9 berhasil disimpan!')
            ->success()
            ->send();
    }
}
